...
Icon con = new ImageIcon(getClass().getResource("/Imagenes/conectar.png"));
Icon ver = new ImageIcon(getClass().getResource("/Imagenes/verificar.png"));
Icon save = new ImageIcon(getClass().getResource("/Imagenes/guardar.png"));
Icon close = new ImageIcon(getClass().getResource("/Imagenes/cerrarcon.png"));
    @Override
    public void apagate() {
        JOptionPane.showMessageDialog(null,"Apagando el servidor de Ecuador", "", JOptionPane.PLAIN_MESSAGE, off);
        System.out.println("Apagando el servidor");
    }

    @Override
    public void prendete() {
        JOptionPane.showMessageDialog(null,"Prendiendo el servidor de Ecuador", "", JOptionPane.PLAIN_MESSAGE, on);
        System.out.println("Prendiendo el servidor");
    }

    @Override
    public void conectate() {
        JOptionPane.showMessageDialog(null,"Conectando el servidor Ecuador", "", JOptionPane.PLAIN_MESSAGE, con);
    ...
    public void cerraConex() {
        JOptionPane.showMessageDialog(null,"Cerrando conexion Ecuador", "", JOptionPane.PLAIN_MESSAGE, close);
